...
if (!isset($_SESSION['ExamTimer']))
{
    $ExamTimer = time() + 30;
    $_SESSION['ExamTimer'] = $ExamTimer;
}

$ExamtimeTilFinish = $_SESSION['ExamTimer'] - time();

echo "<span id=\"timer\"> echo $ExamtimeTilFinish; </span> seconds left"; ?>



<script type="text/javascript">
var TimeLeft = <?php echo $ExamtimeTilFinish; ?>;
...
{        
  ...
  if ( TimeLeft < 0 ) 
  {
   <?php unset($_SESSION['ExamTimer']); ?>
   document.form1.submit();
  }
}
//ExamCountFunc = setInterval(Examcountdown,1000);
</script>
...
class ModelTestLogic
{
  ...
  function displayQuestion()
  {
    ...
    //echo " displayed for testing answer = $answer table_name =$table_name";
    //$qno=$_GET['qno']; 
    echo"$username\n"; 
    ...
    if ($num_rows == 1)
    {
      ...
      echo "<script>
      ExamCountFunc = setInterval(Examcountdown,1000);</script>";
      
      echo "</head><body background=\"img/bkgnd.jpg\" onload=\"function1()\">";
      ...
      {
        echo "<INPUT TYPE=\"hidden\" name=answer1 value=$answer>";
    ...
    // Performing SQL query
      ...
      echo "<table><tr><td><a href=examserver_modelRetest.php>Please click here to continue the Model test</a></td></tr>"; 
    }
    // Free resultset
...
$testLogic = new ModelTestLogic($examserver_hostname);
