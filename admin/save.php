...
if (isset($_POST['quesid'],$_POST['qcode'],$_POST['sname'],$_POST['suid'],$_POST['sub'],$_POST['neg'])) {
	...
	if (mysql_num_rows($result)) {
		...
		// write code for update table
			mysql_query("update result set qcode='".$_POST['qcode']."',sid='".$_POST['suid']."',sname='".$_POST['sname']."',marks=".$marks.",time=now(),sta=0 where qcode='".$_POST['qcode']."' and sid='".$_POST['suid']."'",$conn);
		}
		else {
		...
		mysql_query("insert into result values ('".$_POST['qcode']."','".$_POST['suid']."','".$_POST['sname']."',".$marks.",now(),0)",$conn);
		if (mysql_errno()) {
			print "<font color=\"#FF0000\">Error...</font>";
			exit;
		}
	...
	mysql_close();
	print "Saved! No of Question attempted is ";
	print $corrans+$wrong;
}
?>
</body>
